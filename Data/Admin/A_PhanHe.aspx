<%@ Page Title="Phân Hệ" Language="vb" AutoEventWireup="false" MasterPageFile="~/Data/Admin/Admin.Master" CodeBehind="A_PhanHe.aspx.vb" Inherits="HRM.A_PhanHe" %>
    ...
    <asp:Panel ID="panelPhanQuyen" runat="server">
                ...
                <asp:UpdatePanel ID="upCrudGrid" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" HorizontalAlign="Center" OnRowCommand="GridView1_RowCommand"
                            ...
                            DataKeyNames="MaPhanHe" CssClass="table table-bordered table-responsive" DataSourceID="SqlDataSource1" AllowPaging="True" AllowSorting="True">
                            <Columns>
                                ...
                                <asp:BoundField DataField="MaPhanHe" HeaderText="Mã Phân Hệ" ReadOnly="True" SortExpression="MaPhanHe" />
                            ...
                            <div class="modal-body">
                                ...
                                <table class="table margin-top20">
                                    <tr>
                                        <td>Mã Phân Hệ: (*) </td>
                                        <td>
                                            <asp:TextBox ID="txtMaPhanHe" CssClass="form-control" runat="server" ReadOnly="false"></asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Tên Phân Hệ: (*) </td>
                                        <td>
                                            <asp:TextBox ID="txtTenPhanHe" CssClass="form-control" runat="server"></asp:TextBox>
                            ...
                            <div class="modal-body">
                                ...
                                <table class="table margin-top20">
                                    <tr>
                                        <td>Mã Phân Hệ: (*) </td>
                                        <td>
                                            <asp:TextBox ID="txtMaPhanHe1" CssClass="form-control" runat="server" ReadOnly="True" BackColor="Gray"></asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Tên Phân Hệ: (*) </td>
                                        <td>
                                            <asp:TextBox ID="txtTenPhanHe1" CssClass="form-control" runat="server"></asp:TextBox>
        ...
        <div>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                ...
                SelectCommand="SELECT * FROM [A00_PhanHe]"
                DeleteCommand="DELETE FROM [A00_PhanHe] WHERE [MaPhanHe] = @MaPhanHe"
                InsertCommand="INSERT INTO [A00_PhanHe] ([MaPhanHe], [TenPhanHe]) VALUES (@MaPhanHe, @TenPhanHe)"
                UpdateCommand="UPDATE [A00_PhanHe] SET [TenPhanHe] = @TenPhanHe WHERE [MaPhanHe] = @MaPhanHe">
                <DeleteParameters>
                    <asp:Parameter Name="MaPhanHe" Type="String" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="MaPhanHe" Type="String" />
                    <asp:Parameter Name="TenPhanHe" Type="String" />
                </InsertParameters>
                <UpdateParameters>
                    <asp:Parameter Name="TenPhanHe" Type="String" />
                    <asp:Parameter Name="MaPhanHe" Type="String" />
