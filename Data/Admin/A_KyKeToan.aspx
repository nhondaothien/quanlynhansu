<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="Admin.Master" CodeBehind="A_KyKeToan.aspx.vb" Inherits="HRM.A_KyKeToan" %>
    ...
    <asp:Panel ID="panelPhanQuyen" runat="server">
                ...
                <asp:UpdatePanel ID="upCrudGrid" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" HorizontalAlign="Center" OnRowCommand="GridView1_RowCommand"
                            ...
                            DataKeyNames="MaKy" CssClass="table table-bordered table-responsive" DataSourceID="SqlDataSource1" AllowPaging="True" AllowSorting="True">
                            <Columns>
                                ...
                                <asp:BoundField DataField="MaKy" HeaderText="Mã Kỳ" ReadOnly="True" SortExpression="MaKy" />
                            ...
                            <div class="modal-body">
                                ...
                                <table class="table margin-top20">
                                    <tr>
                                        <td>Mã Kỳ: (*) </td>
                                        <td>
                                            <asp:TextBox ID="txtMaKy" CssClass="form-control" runat="server" ReadOnly="false"></asp:TextBox>
                                        </td>
                                    </tr>
                            ...
                            <div class="modal-body">
                                ...
                                <table class="table margin-top20">
                                    <tr>
                                        <td>Mã Kỳ: (*) </td>
                                        <td>
                                            <asp:TextBox ID="txtMaKy1" CssClass="form-control" runat="server" ReadOnly="True" BackColor="Gray"></asp:TextBox>
                                        </td>
                                    </tr>
        ...
        <div>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                ...
                SelectCommand="SELECT * FROM [fm_KyKeToan]"
                DeleteCommand="DELETE FROM [fm_KyKeToan] WHERE [MaKy] = @MaKy"
                InsertCommand="INSERT INTO [fm_KyKeToan] ([MaKy], [DienGiai]) VALUES (@MaKy, @DienGiai)"
                UpdateCommand="UPDATE [fm_KyKeToan] SET [DienGiai] = @DienGiai WHERE [MaKy] = @MaKy">
                <DeleteParameters>
                    <asp:Parameter Name="MaKy" Type="String" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="MaKy" Type="String" />
