<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Data/Admin/Logout.Master" CodeBehind="A_Logout.aspx.vb" Inherits="HRM.A_Logout" %>
                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="text-center w-75 m-auto">
                                <a href="index.html">
                                    <span>
                                        <img src="/../../Content/images/hrm-small.png" alt="" /></span>
                                </a>
                            </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p class="text-muted">Trở về <a href="A_Login.aspx" class="text-muted font-weight-medium ml-1"><b>Login</b></a></p>
                        </div>
                        <!-- end col -->
                    </div>
                    <!-- end row -->
