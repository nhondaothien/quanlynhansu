Public Class hrU21_QuocTich
    ...
    Protected Sub btnAddRecord_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If IsValid Then
            ...
            parameters("MaQuocTich").DefaultValue = txtMaQuocTich.Text
            parameters("TenQuocTich").DefaultValue = txtTenQuocTich.Text

            Try

                If txtMaQuocTich.Text = "" Then
                    ScriptManager.RegisterStartupScript(Me, [GetType](), "showalert", "alert('Các trường (*) không được bỏ trống.');", True)
                ElseIf txtTenQuocTich.Text = "" Then
                    ScriptManager.RegisterStartupScript(Me, [GetType](), "showalert", "alert('Các trường (*) không được bỏ trống.');", True)
                Else
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As GridViewCommandEventArgs)
        ...
        If e.CommandName.Equals("editRecord") Then
            ...
            txtMaQuocTich1.Text = HttpUtility.HtmlDecode(gvrow.Cells(2).Text).ToString()
            txtTenQuocTich1.Text = HttpUtility.HtmlDecode(gvrow.Cells(3).Text).ToString().ToString()
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As EventArgs)
        If IsValid Then
            ...
            parameters("MaQuocTich").DefaultValue = txtMaQuocTich1.Text
            parameters("TenQuocTich").DefaultValue = txtTenQuocTich1.Text

            Try

                If txtMaQuocTich1.Text = "" Then
                    ScriptManager.RegisterStartupScript(Me, [GetType](), "showalert", "alert('Các trường (*) không được bỏ trống.' );", True)
                ElseIf txtTenQuocTich1.Text = "" Then
                    ScriptManager.RegisterStartupScript(Me, [GetType](), "showalert", "alert('Các trường (*) không được bỏ trống.' );", True)
    ...
    Private Sub executeDelete(ByVal code As String)
        If IsValid Then
            ...
            parameters("MaQuocTich").DefaultValue = code
