Public Class hrU24_TrinhDoHocVan
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As GridViewCommandEventArgs)
        ...
        If e.CommandName.Equals("editRecord") Then
            ...
            txtMaTrinhDoHocVan1.Text = HttpUtility.HtmlDecode(gvrow.Cells(2).Text).ToString()
            txtTrinhDoHocVan1.Text = HttpUtility.HtmlDecode(gvrow.Cells(3).Text).ToString().ToString()
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As EventArgs)
        If IsValid Then
            ...
            parameters("MaTrinhDoHocVan").DefaultValue = txtMaTrinhDoHocVan1.Text
            parameters("TrinhDoHocVan").DefaultValue = txtTrinhDoHocVan1.Text

            Try

                If txtMaTrinhDoHocVan1.Text = "" Then
                    ScriptManager.RegisterStartupScript(Me, [GetType](), "showalert", "alert('Các trường (*) không được bỏ trống.' );", True)
                ElseIf txtTrinhDoHocVan1.Text = "" Then
                    ScriptManager.RegisterStartupScript(Me, [GetType](), "showalert", "alert('Các trường (*) không được bỏ trống.' );", True)
    ...
    Private Sub executeDelete(ByVal code As String)
        If IsValid Then
            ...
            parameters("MaTrinhDoHocVan").DefaultValue = code
