<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="../HR.Master" CodeBehind="hrU15_LoaiBangCap.aspx.vb" Inherits="HRM.hrU15_LoaiBangCap" %>
    ...
    <asp:Panel ID="panelPhanQuyen" runat="server">
                    ...
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" HorizontalAlign="Center" OnRowCommand="GridView1_RowCommand"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="LoaiBangCap" HeaderText="Loại Bằng Cấp" SortExpression="LoaiBangCap"/>
                            </Columns>
                        </asp:GridView>
                    </ContentTemplate>
                    <Triggers>
                            ...
                            <div class="modal-body">
                                ...
                                <table class="table margin-top20">
                                    ...
                                    <tr>
                                        <td>Loại Bằng Cấp: (*) </td>
                                        <td>
                                            <asp:TextBox ID="txtLoaiBangCap" CssClass="form-control" runat="server"></asp:TextBox>
                            ...
                            <div class="modal-body">
                                ...
                                <table class="table margin-top20">
                                    ...
                                    <tr>
                                        <td>Loại Bằng Cấp: (*) </td>
                                        <td>
                                            <asp:TextBox ID="txtLoaiBangCap1" CssClass="form-control" runat="server"></asp:TextBox>
        ...
        <div>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                ...
                SelectCommand="SELECT * FROM [hr_LoaiBangCap]"
                DeleteCommand="DELETE FROM [hr_LoaiBangCap] WHERE [MaLoai] = @MaLoai"
                InsertCommand="INSERT INTO [hr_LoaiBangCap] ([MaLoai], [LoaiBangCap]) VALUES (@MaLoai, @LoaiBangCap)"
                UpdateCommand="UPDATE [hr_LoaiBangCap] SET [LoaiBangCap] = @LoaiBangCap WHERE [MaLoai] = @MaLoai">
                <DeleteParameters>
                    <asp:Parameter Name="MaLoai" Type="String" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="MaLoai" Type="String" />
                    <asp:Parameter Name="LoaiBangCap" Type="String" />
                </InsertParameters>
                <UpdateParameters>
                    <asp:Parameter Name="LoaiBangCap" Type="String" />
                    <asp:Parameter Name="MaLoai" Type="String" />
