<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="../HR.Master" CodeBehind="hrU16_LoaiChungChi.aspx.vb" Inherits="HRM.hrU16_ChungChi" %>
    ...
    <asp:Panel ID="panelPhanQuyen" runat="server">
                            ...
                            <div class="modal-body">
                                ...
                                <table class="table margin-top20">
                                    ...
                                    <tr>
                                        <td>Loại Bằng Cấp: (*) </td>
                                        <td>
                                            <asp:TextBox ID="txtLoaiChungChi" CssClass="form-control" runat="server"></asp:TextBox>
                            ...
                            <div class="modal-body">
                                ...
                                <table class="table margin-top20">
                                    ...
                                    <tr>
                                        <td>Loại Bằng Cấp: (*) </td>
                                        <td>
                                            <asp:TextBox ID="txtLoaiChungChi1" CssClass="form-control" runat="server"></asp:TextBox>
        ...
        <div>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                ...
                SelectCommand="SELECT * FROM [hr_LoaiChungChi]"
                DeleteCommand="DELETE FROM [hr_LoaiChungChi] WHERE [MaLoai] = @MaLoai"
                InsertCommand="INSERT INTO [hr_LoaiChungChi] ([MaLoai], [LoaiChungChi]) VALUES (@MaLoai, @LoaiChungChi)"
                UpdateCommand="UPDATE [hr_LoaiChungChi] SET [LoaiChungChi] = @LoaiChungChi WHERE [MaLoai] = @MaLoai">
                <DeleteParameters>
                    <asp:Parameter Name="MaLoai" Type="String" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="MaLoai" Type="String" />
                    <asp:Parameter Name="LoaiChungChi" Type="String" />
                </InsertParameters>
                <UpdateParameters>
                    <asp:Parameter Name="LoaiChungChi" Type="String" />
                    <asp:Parameter Name="MaLoai" Type="String" />
