<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="../HR.Master" CodeBehind="hrU21_QuocTich.aspx.vb" Inherits="HRM.hrU21_QuocTich" %>
    ...
    <asp:Panel ID="panelPhanQuyen" runat="server">
                ...
                <asp:UpdatePanel ID="upCrudGrid" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" HorizontalAlign="Center" OnRowCommand="GridView1_RowCommand"
                            ...
                            DataKeyNames="MaQuocTich" CssClass="table table-bordered table-responsive" DataSourceID="SqlDataSource1" AllowPaging="True" AllowSorting="True">
                            <Columns>
                                ...
                                <asp:BoundField DataField="MaQuocTich" HeaderText="Mã Quốc Tịch" ReadOnly="True" SortExpression="MaQuocTich" />
                                <asp:BoundField DataField="TenQuocTich" HeaderText="Tên Quốc Tịch" SortExpression="TenQuocTich"/>
                            </Columns>
                        </asp:GridView>
                    </ContentTemplate>
                    <Triggers>
                    ...
                    <asp:UpdatePanel ID="upAdd" runat="server">
                        <ContentTemplate>
                            <div class="modal-body">
                                <%-- ([MaQuocTich], [TenQuocTich]) --%>
                                <table class="table margin-top20">
                                    <tr>
                                        <td>Mã Quốc Tịch: (*) </td>
                                        <td>
                                            <asp:TextBox ID="txtMaQuocTich" CssClass="form-control" runat="server" ReadOnly="false"></asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Tên Quốc Tịch: (*) </td>
                                        <td>
                                            <asp:TextBox ID="txtTenQuocTich" CssClass="form-control" runat="server"></asp:TextBox>
                            ...
                            <div class="modal-body">
                                ...
                                <table class="table margin-top20">
                                    <tr>
                                        <td>Mã Quốc Tịch: (*) </td>
                                        <td>
                                            <asp:TextBox ID="txtMaQuocTich1" CssClass="form-control" runat="server" ReadOnly="True" BackColor="Gray"></asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Tên Quốc Tịch: (*) </td>
                                        <td>
                                            <asp:TextBox ID="txtTenQuocTich1" CssClass="form-control" runat="server"></asp:TextBox>
        ...
        <div>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                ...
                SelectCommand="SELECT * FROM [hr_QuocTich]"
                DeleteCommand="DELETE FROM [hr_QuocTich] WHERE [MaQuocTich] = @MaQuocTich"
                InsertCommand="INSERT INTO [hr_QuocTich] ([MaQuocTich], [TenQuocTich]) VALUES (@MaQuocTich, @TenQuocTich)"
                UpdateCommand="UPDATE [hr_QuocTich] SET [TenQuocTich] = @TenQuocTich WHERE [MaQuocTich] = @MaQuocTich">
                <DeleteParameters>
                    <asp:Parameter Name="MaQuocTich" Type="String" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="MaQuocTich" Type="String" />
                    <asp:Parameter Name="TenQuocTich" Type="String" />
                </InsertParameters>
                <UpdateParameters>
                    <asp:Parameter Name="TenQuocTich" Type="String" />
                    <asp:Parameter Name="MaQuocTich" Type="String" />
