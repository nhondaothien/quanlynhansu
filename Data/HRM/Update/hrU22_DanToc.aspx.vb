Public Class hrU22_DanToc
    ...
    Protected Sub btnAddRecord_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If IsValid Then
            ...
            parameters("MaDanToc").DefaultValue = txtMaDanToc.Text
            parameters("TenDanToc").DefaultValue = txtTenDanToc.Text
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As GridViewCommandEventArgs)
        ...
        If e.CommandName.Equals("editRecord") Then
            ...
            txtMaDanToc1.Text = HttpUtility.HtmlDecode(gvrow.Cells(2).Text).ToString()
            txtTenDanToc1.Text = HttpUtility.HtmlDecode(gvrow.Cells(3).Text).ToString().ToString()
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As EventArgs)
        If IsValid Then
            ...
            parameters("MaDanToc").DefaultValue = txtMaDanToc1.Text
            parameters("TenDanToc").DefaultValue = txtTenDanToc1.Text

            Try

                If txtMaDanToc1.Text = "" Then
                    ScriptManager.RegisterStartupScript(Me, [GetType](), "showalert", "alert('Các trường (*) không được bỏ trống.' );", True)
                ElseIf txtTenDanToc1.Text = "" Then
                    ScriptManager.RegisterStartupScript(Me, [GetType](), "showalert", "alert('Các trường (*) không được bỏ trống.' );", True)
    ...
    Private Sub executeDelete(ByVal code As String)
        If IsValid Then
            ...
            parameters("MaDanToc").DefaultValue = code
