<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="../HR.Master" CodeBehind="hrU20_ChucVu.aspx.vb" Inherits="HRM.hrU20_ChucVu" %>
    ...
    <asp:Panel ID="panelPhanQuyen" runat="server">
                ...
                <asp:UpdatePanel ID="upCrudGrid" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" HorizontalAlign="Center" OnRowCommand="GridView1_RowCommand"
                            ...
                            DataKeyNames="MaChucVu" CssClass="table table-bordered table-responsive" DataSourceID="SqlDataSource1" AllowPaging="True" AllowSorting="True">
                            <Columns>
                                ...
                                <asp:BoundField DataField="MaChucVu" HeaderText="Mã Chức Vụ" ReadOnly="True" SortExpression="MaChucVu" />
                                <asp:BoundField DataField="TenChucVu" HeaderText="Tên Chức Vụ" SortExpression="TenChucVu"/>
                            </Columns>
                        </asp:GridView>
                    </ContentTemplate>
                    <Triggers>
                            ...
                            <div class="modal-body">
                                ...
                                <table class="table margin-top20">
                                    <tr>
                                        <td>Mã Dân Tộc: (*) </td>
                                        <td>
                                            <asp:TextBox ID="txtMaChucVu" CssClass="form-control" runat="server" ReadOnly="false"></asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Tên Dân Tộc: (*) </td>
                                        <td>
                                            <asp:TextBox ID="txtTenChucVu" CssClass="form-control" runat="server"></asp:TextBox>
                            ...
                            <div class="modal-body">
                                ...
                                <table class="table margin-top20">
                                    <tr>
                                        <td>Mã Dân Tộc: (*) </td>
                                        <td>
                                            <asp:TextBox ID="txtMaChucVu1" CssClass="form-control" runat="server" ReadOnly="True" BackColor="Gray"></asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Tên Dân Tộc: (*) </td>
                                        <td>
                                            <asp:TextBox ID="txtTenChucVu1" CssClass="form-control" runat="server"></asp:TextBox>
        ...
        <div>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                ...
                SelectCommand="SELECT * FROM [hr_ChucVu]"
                DeleteCommand="DELETE FROM [hr_ChucVu] WHERE [MaChucVu] = @MaChucVu"
                InsertCommand="INSERT INTO [hr_ChucVu] ([MaChucVu], [TenChucVu]) VALUES (@MaChucVu, @TenChucVu)"
                UpdateCommand="UPDATE [hr_ChucVu] SET [TenChucVu] = @TenChucVu WHERE [MaChucVu] = @MaChucVu">
                <DeleteParameters>
