...
Public Class hrU12_KhenThuong
    ...
    Protected Sub btnAddRecord_Click(sender As Object, e As EventArgs) Handles btnAddRecord.Click
        '-[hr_Thuong] ([NgayThuong], [SoTien], [LyDoThuong], [GhiChu], [MaNhanVien])
        Dim NgayThuong As String = txtNgayThuong.Text
        Dim SoTien As String = txtSoTien.Text
        Dim LyDoThuong As String = txtLyDoThuong.Text
        ...
        parameters("NgayThuong").DefaultValue = NgayThuong
        parameters("SoTien").DefaultValue = SoTien
        parameters("LyDoThuong").DefaultValue = LyDoThuong
        parameters("GhiChu").DefaultValue = GhiChu
        parameters("MaNhanVien").DefaultValue = MaNhanVien

        Try
            If (txtNgayThuong.Text = "") Then
    ...
    Protected Sub GridView1_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GridView1.RowCommand
        ...
        If (e.CommandName.Equals("editRecord")) Then
            ...
            txtMaThuong1.Text = HttpUtility.HtmlDecode(gvrow.Cells(2).Text).ToString()
            txtNgayThuong1.Text = HttpUtility.HtmlDecode(gvrow.Cells(3).Text).ToString().Trim()
            txtSoTien1.Text = HttpUtility.HtmlDecode(gvrow.Cells(4).Text).ToString().Trim()
            txtLyDoThuong1.Text = HttpUtility.HtmlDecode(gvrow.Cells(5).Text).ToString().Trim()
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Dim MaThuong As String = txtMaThuong1.Text
        Dim NgayThuong As String = txtNgayThuong1.Text
        Dim SoTien As String = txtSoTien1.Text
        Dim LyDoThuong As String = txtLyDoThuong1.Text
        ...
        parameters("MaThuong").DefaultValue = MaThuong
        parameters("NgayThuong").DefaultValue = NgayThuong
        parameters("SoTien").DefaultValue = SoTien
        parameters("LyDoThuong").DefaultValue = LyDoThuong
        parameters("GhiChu").DefaultValue = GhiChu
    ...
    Private Sub executeDelete(ByVal code As String)
        If IsValid Then
            ...
            parameters("MaThuong").DefaultValue = code
