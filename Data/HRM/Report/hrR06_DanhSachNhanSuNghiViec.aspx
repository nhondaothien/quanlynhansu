<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="../HR.Master" CodeBehind="hrR06_DanhSachNhanSuNghiViec.aspx.vb" Inherits="HRM.hrR06_DanhSachNhanSuNghiViec" %>
    ...
    <div class="list-group">
        ...
        <div class="list-group-item" style="height: 1000px">
            <rsweb:ReportViewer ID="rpvReport" runat="server" Height="100%" Width="1011" BackColor="LightBlue"
                ...
                <LocalReport ReportPath="Report\HRM\hrR06_DanhSachNhanSuNghiViec.rdlc" ReportEmbeddedResource="HRM.hrR06_DanhSachNhanSuNghiViec.rdlc" EnableExternalImages="True">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="dsDanhSachNhanVien" />
                    </DataSources>
                </LocalReport>

            </rsweb:ReportViewer>
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetDataByMaChiNhanhVaNgayNghi" TypeName="HRM.dsHRMTableAdapters.vhr_NhanSuTableAdapter" OldValuesParameterFormatString="original_{0}">
                <SelectParameters>
