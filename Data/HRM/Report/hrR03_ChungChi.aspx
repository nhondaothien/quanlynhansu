<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="../HR.Master" CodeBehind="hrR03_ChungChi.aspx.vb" Inherits="HRM.hrR03_ChungChi" %>
    ...
    <div class="list-group">
        ...
        <div class="list-group-item" style="height: 1000px">
            <rsweb:ReportViewer ID="rpvReport" runat="server" Height="100%" Width="1011" BackColor="LightBlue"
                ...
                <LocalReport ReportPath="Report\HRM\hrR03_ChungChi.rdlc" ReportEmbeddedResource="HRM.hrR03_ChungChi.rdlc" EnableExternalImages="True">
                    <DataSources>
